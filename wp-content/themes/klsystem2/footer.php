<footer id="footer" class="footer">
    <div class="container__header">
        <div class="footer-wrap">
            ...
            <div class="footer__item">
                <a href="/it-outsource/" class="footer__link">IT Аутсорсинг</a>
                <a href="/zabbix/" class="footer__link">Zabbix</a>
                <a href="/1c/" class="footer__link">1C</a>
                <a href="/wtware/" class="footer__link">WtWare</a>
            </div>
            <div class="footer__item">
                <a href="/ip-telephony/" class="footer__link">IP телефония</a>
                <a href="/sites/" class="footer__link">Сайты</a>
                <a href="/network/" class="footer__link">Сети передачи данных</a>
                <a href="/video-surveillance/" class="footer__link">Видеонаблюдение</a>
            </div>
            <div class="footer__item">
                ...
                <a href="/about-us/" class="footer__link footer__link__bold">О нас</a>
                <a href="/contacts/" class="footer__link footer__link__bold">Контакты</a>
            </div>
        </div>
    </div>
</footer>
